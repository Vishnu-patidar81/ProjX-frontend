...
export default function GuideSubmissions() {
  ...
  const fetchSubmissions = async () => {
    try {
      const { data } = await api.get('/submissions/reviewer?mode=guide')
  ...
  return (
    <PageLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Student Submissions (Guide View)</h1>
          <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">
            Review academic file uploads from student groups assigned to you as Project Guide.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="card text-center py-16 bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-xl shadow-xs">
            ...
            <p className="text-sm text-gray-400 mt-2 max-w-md mx-auto">
              Submissions made to you as guide for review will appear here.
            </p>
          </div>
        ) : (
